<template>
    <section class="mypage-main">
        <div class="title-container">
            ...
            <NuxtLink to="/mypage/order" class="link">전체보기<i class="arrow"></i></NuxtLink>
        </div>
        <!-- // 최근 주문 내역 -->
        ...
        <div class="title-container">
            ...
            <NuxtLink to="/mypage/favorite" class="link">전체보기<i class="arrow"></i></NuxtLink>
        </div>
        <!-- // 관심상품 -->
        <div class="liked-item-list">
            <ItemList :itemData="itemData" :itemListRatio="3" />
        </div>
        <!-- // 페이징 -->
        <uiPagination :currentPage="pageSet.currentPage" :totalPages="pageSet.totalPages" />
        <!-- 
        ...
        <!-- 구성상품보기 모달 -->
        <modal-default :title="'구성상품보기'" :modalTypeClass="'item-grid'" :modalShow="modalStatus.itemGridShow"
            :dimmedShow="true" @modalClose="modalStatus.itemGridShow = false">
            <ItemList :itemData="itemData" :itemListRatio="4" :containerDirection="'vertical'" />
            <uiPagination :currentPage="pageSet.currentPage" :totalPages="pageSet.totalPages" />
        </modal-default>
    </section>
</template>
