    ...
    <section class="mypage-order mypage-order-detail">
        ...
        <div class="order-item-wrapper">
            ...
            <div class="order-item">
                <div class="info">
                    <span class="date">2023. 12. 17 12:00:00</span>
                    <span class="detail">
                        <span>주문번호</span>
                        <span>K12345678901349</span>
                    </span>
                </div>
                <div class="order-status">
                    <div class="wrapper">
                        <p class="delivery-status-wrap"><span class="status deposit-waiting">배송중</span></p>
                        <div class="item-wrap">
                                ...
                                <div class="item-list">
                                    ...
                                    <div class="info-container">
                                        <div class="title-main paragraph-ellipsis">
                                            <b>[브랜드명]</b>제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역 50g X 2
                                            제품명이
                                            노출되는 영역 50g X 2
                                        </div>
                                        <div class="title-sub paragraph-ellipsis">
                                            <b>[옵션1]</b>서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 <b>[옵션2]</b> 서브 타이틀 서브 타이틀 서브 타이틀 서브
                                            타이틀
                                            서브
                                            타이틀 서브 타이틀 서브
                                            타이틀 서브 타이틀
                                        ...
                                        <div class="underline red" @click="alert('팝업')">
                                            구성 상품 보기
                                        </div>
                                        <div class="purchase-amount">
                                            <p class="price">9,999,999원</p>
                                            <p class="amount">수량 999개</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn-wrap">
                                <div class="box">
                                    <button type='button' class="btn btn-default btn-middle btn-cancel"
                                        @click="cancelModalShow = !cancelModalShow">주문취소</button>
                                </div>
                            </div>
                            <div class="btn-wrap" style="display:none;">
                                <div class="box">
                                    <button type="button" class="btn btn-primary btn-middle btn-review"
                                        @click="reviewModalShow = !reviewModalShow">후기작성</button>
                                    <button type='button' class="btn btn-primary btn-middle"
                                        @click="buyConfirmModalShow = !buyConfirmModalShow"
                                        style="display:none;">구매확정</button>
                                    <button type='button' class="btn btn-primary-line btn-middle">배송조회</button>
                                </div>
                                <div class="box">
                                    <button type='button' class="btn btn-default btn-middle"
                                        @click="exchangeModalShow = !exchangeModalShow">교환신청
                                    </button>
                                    <button type='button' class="btn btn-default btn-middle"
                                        @click="returnModalShow = !returnModalShow">반품신청</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="wrapper">
                        ...
                        <div class="item-wrap">
                            ...
                            <div class="btn-wrap">
                                <div class="box">
                                    <button type="button" class="btn btn-primary btn-middle btn-review"
                                        @click="reviewModalShow = !reviewModalShow" style="display:none;">후기작성</button>
                                    <button type='button' class="btn btn-primary btn-middle"
                                        @click="buyConfirmModalShow = !buyConfirmModalShow">구매확정</button>
                                    <button type='button' class="btn btn-primary-line btn-middle">배송조회</button>
                                </div>
                                <div class="box">
                                    <button type='button' class="btn btn-default btn-middle"
        ...
        <div class="order-info">
            ...
            <div class="content-table list">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>주소</th>
                            <td>[08381] 서울 구로구 디지털로27길 24 (벽산디지털밸리) 711호 온라인파워스</td>
                        </tr>
                        <tr>
                            <th>연락처</th>
                            <td>010-1234-5678</td>
            ...
            <div class="payment">
                <div class="payment-info content-table">
                    <dl class="sub-title">
                        <dt>총 상품금액</dt>
                        <dd><span>19,900</span>원</dd>
                    </dl>
                    <dl class="sub">
                        <dt>상품할인</dt>
                        <dd><span>300</span>원</dd>
                    </dl>
                    <dl class="sub">
                        <dt>세트할인</dt>
                        <dd><span>300</span>원</dd>
                ...
                <div class="payment-method content-table">
                    <dl>
                        <dt>
                            <p>
                                <strong>신용카드</strong>
                                <span class="status cancel">결제취소</span>
                                <button type="button" class="btn-recipe">영수증 보기</button>
                            </p>
                            <p class="amount"><b>19,900</b>원</p>
                        </dt>
                        <dd>
        ...
        <button type="button" class="btn btn-large btn-primary-line btn-round btn-back print-none"
        ...
        <!--
            ...
            -->
        <!-- 반품신청 모달 -->
        <div class="modal modal-product" :class="{ 'show': returnModalShow }">
            <div class="dimmed-bg"></div>
            <div class="modal-wrap">
                <button class="modal-close" @click="returnModalShow = !returnModalShow">닫기</button>
                <div class="modal-header">
                    반품신청
                </div>
                <div class="p-2 modal-body type-return">
                    <form action="">
                        <!-- 아이템 영역 -->
                        <div class="item-list-container horizon">
                            <div class="item-list">
                                ...
                                <div class="info-container">
                                    <div class="title-main paragraph-ellipsis">
                                        <b>[브랜드명]</b>제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역 50g X 2 제품명이
                                        노출되는 영역
                                        50g X 2
                                    </div>
                                    <div class="title-sub paragraph-ellipsis">
                                        <b>[옵션1]</b>서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 <b>[옵션2]</b> 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀
                                        서브
                                        타이틀
                                        서브 타이틀 서브
                                        타이틀 서브 타이틀
                                    ...
                                    <div class="select-wrap select-amount">
                                        <span>수량</span>
                                        <select name="" id="" class="input-select small-arr">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-basic" placeholder="반품 사유를 입력하세요" />
                        ...
                        <ul class="photo-list">
                            <li class="photo-item">
                                <img src="~/assets/image/sample/no_content.png" alt="fileName" class="thumbnail">
                                <button type="button" class="btn-delete"></button>
                            </li>
                            <li class="photo-item">
                                <img src="~/assets/image/sample/no_content_720480.png" alt="fileName" class="thumbnail">
                                <button type="button" class="btn-delete"></button>
                            </li>
                            <li class="photo-item">
                                <img src="~/assets/image/sample/no_content_7201440.png" alt="fileName"
                                    class="thumbnail">
                                <button type="button" class="btn-delete"></button>
                            </li>
                            <li class="photo-item">
                                <img src="~/assets/image/sample/thum.png" alt="fileName" class="thumbnail">
                                <button type="button" class="btn-delete"></button>
                            </li>
                        </ul>
                        ...
                        <div class="radio-wrap">
                            <label class="input-radio"><input type="radio" name="exchange-way" v-model="deliveryOption"
                                    value="return"><i></i>회수요청
                            </label>
                            <label class="input-radio"><input type="radio" name="exchange-way" v-model="deliveryOption"
                                    value="direct"> <i></i>직접발송</label>
                        </div>
                        <div class="form-line package" v-show="deliveryOption === 'direct'">
                            <div class="flex">
                                <div class="select-wrap">
                        ...
                        <div class="link-wrap">
                            ...
                            <button type="button" class="btn btn-default link-item w-half"
                                @click="returnModalShow = !returnModalShow">취소</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- 교환신청 모달 -->
        <div class="modal modal-product" :class="{ 'show': exchangeModalShow }">
            <div class="dimmed-bg"></div>
            <div class="modal-wrap">
                <button class="modal-close" @click="exchangeModalShow = !exchangeModalShow">닫기</button>
                <div class="modal-header">
                    교환신청
                </div>
                <div class="p-2 modal-body type-exchange">
                    <form action="">
                        <!-- 아이템 영역 -->
                        <div class="item-list-container horizon">
                            <div class="item-list">
                        ...
                        <div class="link-wrap">
                            <button type="submit" class="btn btn-primary link-item w-half">신청</button>
                            <button type="button" class="btn btn-default link-item w-half"
                                @click="exchangeModalShow = !exchangeModalShow">취소</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- 취소신청 모달 -->
        <div class="modal modal-product" :class="{ 'show': cancelModalShow }">
            <div class="dimmed-bg"></div>
            <div class="modal-wrap">
                <button class="modal-close" @click="cancelModalShow = !cancelModalShow">닫기</button>
                <div class="modal-header">
                    취소신청
                </div>
                <div class="p-2 modal-body type-cancel">
                    <form action="">
                        ...
                        <div class="link-wrap">
                            <button type="submit" class="btn btn-primary link-item w-half">신청</button>
                            <button type="button" class="btn btn-default link-item w-half"
                                @click="cancelModalShow = !cancelModalShow">취소</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- 구매확정 모달 -->
        <div class="modal modal-product modal-review" :class="{ 'show': buyConfirmModalShow }">
            <div class="dimmed-bg"></div>
            <div class="modal-wrap">
                <button class="modal-close" @click="buyConfirmModalShow = !buyConfirmModalShow">닫기</button>
                <div class="modal-header">
                    구매확정
                </div>
                <div class="p-2 modal-body">
                    ...
                    <form action="">
                        ...
                        <ul class="photo-list" v-show="checkPhotoList">
                            <li class="photo-item">
                                <img src="~/assets/image/sample/no_content.png" alt="fileName" class="thumbnail">
                                <button type="button" class="btn-delete"></button>
                            </li>
                        ...
                        <div class="link-wrap">
                            ...
                            <button type="button" class="btn btn-default link-item w-half"
                                @click="buyConfirmModalShow = !buyConfirmModalShow">취소</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- 후기작성 모달 -->
        <div class="modal modal-product modal-review" :class="{ 'show': reviewModalShow }">
            <div class="dimmed-bg"></div>
            <div class="modal-wrap">
                <button class="modal-close" @click="reviewModalShow = !reviewModalShow">닫기</button>
                <div class="modal-header">
                    후기작성
                </div>
                <div class="p-2 modal-body">
                    <form action="">
                        ...
                        <div class="link-wrap">
                            <button type="submit" class="btn btn-primary link-item w-half">등록</button>
                            <button type="button" class="btn btn-default link-item w-half"
                                @click="reviewModalShow = !reviewModalShow">취소</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="item-list-container vertical">
                        <div class="item-list item-list-4">
                            ...
                            <div class="info-container">
                                <div class="title-main paragraph-ellipsis">
                                    [브랜드명] 제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역 50g X 2 제품명이 노출되는 영역
                                    50g X
                                    2
                                </div>
                                <div class="title-sub paragraph-ellipsis">
                                    서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀 서브 타이틀
                                    서브
                                    타이틀 서브
                                    타이틀 서브
                                    타이틀
...
const buyConfirmModalShow = ref(false);
const cancelModalShow = ref(false);
const exchangeModalShow = ref(false);
const returnModalShow = ref(false);
const checkPhotoList = ref(true);
const deliveryOption = ref('return');


const showModalProduct = () => {
    document.querySelector('.modal.item-grid').classList.add('show');
};
